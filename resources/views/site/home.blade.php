...
<head>
    ...
    <link rel="alternate stylesheet" type="text/css" title="blue" href="{{ asset('site/assets/css/skins/blue.css') }}" />
    <link rel="alternate stylesheet" type="text/css" title="blueviolet" href="{{ asset('site/assets/css/skins/blueviolet.css') }}" />
    <link rel="alternate stylesheet" type="text/css" title="goldenrod" href="{{ asset('site/assets/css/skins/goldrenrod.css') }}" />
    <link rel="alternate stylesheet" type="text/css" title="green" href="{{ asset('site/assets/css/skins/green.css') }}" />
    <link rel="alternate stylesheet" type="text/css" title="magenta" href="{{ asset('site/assets/css/skins/magenta.css') }}" />
    <link rel="alternate stylesheet" type="text/css" title="orange" href="{{ asset('site/assets/css/skins/orange.css') }}" />
    <link rel="alternate stylesheet" type="text/css" title="purple" href="{{ asset('site/assets/css/skins/purple.css') }}" />
    <link rel="alternate stylesheet" type="text/css" title="red" href="{{ asset('site/assets/css/skins/red.css') }}" />
	<link rel="alternate stylesheet" type="text/css" title="yellow" href="{{ asset('site/assets/css/skins/yellow.css') }}" />
	<link rel="alternate stylesheet" type="text/css" title="yellowgreen" href="{{ asset('site/assets/css/skins/yellowgreen.css') }}" />
...
<body class="dark">
    ...
    <div id="switcher" class="">
        <div class="content-switcher">
            ...
            <ul>
                <li>
                    <a href="#" onclick="setActiveStyleSheet('purple');" title="purple" class="color"><img src="{{ asset('site/assets/images/styleswitcher/purple.png') }}" alt="purple"/></a>
                </li>
                <li>
                    <a href="#" onclick="setActiveStyleSheet('red');" title="red" class="color"><img src="{{ asset('site/assets/images/styleswitcher/red.png') }}" alt="red"/></a>
                </li>
                <li>
                    <a href="#" onclick="setActiveStyleSheet('blueviolet');" title="blueviolet" class="color"><img src="{{ asset('site/assets/images/styleswitcher/blueviolet.png') }}" alt="blueviolet"/></a>
                </li>
                <li>
                    <a href="#" onclick="setActiveStyleSheet('blue');" title="blue" class="color"><img src="{{ asset('site/assets/images/styleswitcher/blue.png') }}" alt="blue"/></a>
                </li>
                <li>
                    <a href="#" onclick="setActiveStyleSheet('goldenrod');" title="goldenrod" class="color"><img src="{{ asset('site/assets/images/styleswitcher/goldenrod.png') }}" alt="goldenrod"/></a>
                </li>
                <li>
                    <a href="#" onclick="setActiveStyleSheet('magenta');" title="magenta" class="color"><img src="{{ asset('site/assets/images/styleswitcher/magenta.png') }}" alt="magenta"/></a>
                </li>
                <li>
                    <a href="#" onclick="setActiveStyleSheet('yellowgreen');" title="yellowgreen" class="color"><img src="{{ asset('site/assets/images/styleswitcher/yellowgreen.png') }}" alt="yellowgreen"/></a>
                </li>
                <li>
                    <a href="#" onclick="setActiveStyleSheet('orange');" title="orange" class="color"><img src="{{ asset('site/assets/images/styleswitcher/orange.png') }}" alt="orange"/></a>
                </li>
				<li>
                    <a href="#" onclick="setActiveStyleSheet('green');" title="green" class="color"><img src="{{ asset('site/assets/images/styleswitcher/green.png') }}" alt="green"/></a>
                </li>
				<li>
                    <a href="#" onclick="setActiveStyleSheet('yellow');" title="yellow" class="color"><img src="{{ asset('site/assets/images/styleswitcher/yellow.png') }}" alt="yellow"/></a>
                </li>
            </ul>
			<h4>BODY SKIN</h4>
                        ...
                        <div class="row">
                            ...
                            <div class="col s12 m8 l12 xl12 personal-info section-padding">
								...
								<div class="col m12 l12 xl9 p-none">
									<p class="second-font">As a Laravel developer, I am driven by my passion for problem-solving, data structures, and design patterns. Continuously
                                        honing my skills allows me to enhance my performance as a software engineer. I am constantly motivated to apply my
                                ...
                                <div class="col s12 m12 l6 p-none">
                                    <ul class="second-font list-2">
                                        ...
                                        <li><span class="font-weight-700">Address: </span>Alsharqia,Lives In Cairo </li>
										...
										<li><span class="font-weight-700">Linkdin: </span><a href="https://www.linkedin.com/in/ahmed-ezz-45115426b/">ahmedezz</a></li>
                                    </ul>
                                </div>
