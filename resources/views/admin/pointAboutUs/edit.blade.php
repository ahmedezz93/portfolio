...
@section('content')
    <div class="card mb-4">
        ...
        <div class="alert alert-info" role="alert">
            <h5 class="card-header1">Edit Point About Us</h5>
        </div><br><br>

        <form class="card-body" action="{{ route('admin.points.update',$point->id) }}" method="post" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="row g-3">
                <!-- Name Field -->
                ...
                <div class="col-md-12">
                    ...
                    <textarea class="form-control" id="point-description" name="description" rows="4" cols="5">{{ old('description',$point->description) }}</textarea>
                    @error('description')
                        <div class="text-danger">{{ $message }}</div>
                    @enderror
                </div>
