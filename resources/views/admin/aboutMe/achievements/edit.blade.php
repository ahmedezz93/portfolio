...
@section('content')
    <div class="card mb-4">
        <div class="alert alert-info" role="alert">
            <h5 class="card-header1">Edit Achievement</h5>
        </div>

        <form class="card-body" action="{{ route('admin.achievements.update', $achievement->id) }}" method="post"
            ...
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" id="project-years_of_experience" name="years_of_experience" class="form-control"
                        value="{{ old('years_of_experience',$achievement->years_of_experience) }}" />
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" id="project-done_projects" name="done_projects" class="form-control"
                        value="{{ old('done_projects',$achievement->done_projects) }}" />
                    @error('done_projects')
                        <div class="text-danger">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" id="project-happy_customers" name="happy_customers" class="form-control"
                        value="{{ old('happy_customers',$achievement->happy_customers) }}" />
